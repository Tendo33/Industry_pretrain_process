...
if __name__ == "__main__":
    # 使用示例
    jsonl_file = "/data/nfs/data/Infinity-Instruct-jsonl/gen.jsonl"  # 输入文件名
    output_file = "/home/sunjinf/github_projet/nature_data/sft_data/Infinity-Instruct_dataset.jsonl"  # 输出文件名
