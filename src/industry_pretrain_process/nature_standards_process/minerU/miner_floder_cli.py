...
logger = get_logger('mineru_folder_cli', formatter_template=5,)
os.environ["CUDA_VISIBLE_DEVICES"] = "3"


def process_pdfs_in_directory(directory, model_path='', method='auto', inside_model=True, model_mode='full'):
    """
