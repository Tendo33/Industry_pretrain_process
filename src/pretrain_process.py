...
def create_temp_dict(content_list: list[str], lang_score_list: list[float],
                     special_char_ratio_list: list[float], char_rep_ratio_list: list[float],
                     perplexity_list: list[float]) -> list[dict]:
    temp_list = []
...
def process_base(source_file_path: str, target_file_path: str) -> None:
    keys = ["text", "lang_score", "special_char_ratio",
...
if __name__ == '__main__':
    ...
    target_file_path = r'/data/nfs/data/Industry_raw_data/agriculture_filter.jsonl'
